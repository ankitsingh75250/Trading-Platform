               ...
               <div className='row p-5'>
                    ...
                    <div className='col-6 p-5'>
                         ...
                         <div className='text-center '>
                              <a href="/signup" className='mx-5' style={{textDecoration:"none"}}>Explore our products <i class="fa-solid fa-right-long"></i></a>
                              <a href="/signup" style={{textDecoration:"none"}}>Try Kite demo  <i class="fa-solid fa-right-long"></i></a>
                         </div>
                    </div>
               </div>
          </div> 
