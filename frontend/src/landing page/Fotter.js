      ...
      <div className="row mt-5">
        <div className="col">
          <img className="mb-3"
            ...
            alt="logo"
          />
          <p>&copy; 2010 - 2025, Zerodha Broking Ltd. All rights reserved.</p>  <i class="fa-brands fa-x-twitter"></i> <i class="fa-brands fa-square-facebook"></i>   <i class="fa-brands fa-instagram"></i> <i class="fa-brands fa-linkedin"></i> 
